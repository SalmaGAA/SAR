...
#' mutation rate, \code{Rm}. Each gene within \code{bCell} is either represented as 1 or 0, depending on the
#' mutation status of that gene, where 0 represnts an unmutated gene, and 1 represnts a mutated gene.
