#'
#' @title Summarize Scenario for Bacterial Genotype with Graphs and Statistics
#'
...
#'
#' @usage scenarioSummary(scenario, gen.pd, nDay, Nl, Ng, ylim)
#'
...
#' @examples
#' scenarioSummary(scenario = scenarioSimulate, gen.pd = 24, nDay = 20, Nl = c(1, 2, 3), Ng = c(10, 10, 10), ylim = c(0.5, 0.85))
...
#' @export
scenarioSummary <- function(scenario, gen.pd, nDay, Nl, Ng, ylim) {
